...
export const StoriesModal: React.FC<StoriesModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black z-50 flex items-center justify-center">
      ...
      <div className="relative w-full max-w-sm mx-4 h-full max-h-[90vh] bg-black rounded-lg overflow-hidden">
        {/* Progress bars */}
        ...
        <div className="absolute inset-0 flex z-10">
          <div className="flex-1 cursor-pointer" onClick={goToPreviousStory} />
          <div className="flex-1 cursor-pointer" onClick={goToNextStory} />
        </div>

  ...
  return (
    <>
      ...
      <Sidebar 
        variant="sidebar" 
        collapsible="icon" 
        className={`border-r border-amber-200 bg-white h-full ${isMinimalMode ? 'w-20' : 'w-64'}`}
      >
          ...
          <SidebarMenu className="space-y-1">
            <SidebarMenuItem>
              <SidebarMenuButton 
                asChild 
                tooltip="Home" 
                className={`${isMinimalMode ? 'h-14 w-14 mx-auto flex items-center justify-center rounded-xl hover:bg-amber-50 transition-colors' : 'py-3 text-sm'}`}
              >
                <Link to="/home" className={`flex items-center gap-3 font-medium ${isMinimalMode ? 'justify-center' : ''}`}>
            ...
            <SidebarMenuItem>
              <SidebarMenuButton 
                ...
                className={`${isMinimalMode ? 'h-14 w-14 mx-auto flex items-center justify-center rounded-xl hover:bg-amber-50 transition-colors' : 'py-3 text-sm'}`}
              >
                <Link to="/explore" className={`flex items-center gap-3 font-medium ${isMinimalMode ? 'justify-center' : ''}`}>
            ...
            <SidebarMenuItem>
              ...
              >
                <div className={`flex items-center gap-3 font-medium cursor-pointer ${isMinimalMode ? 'justify-center relative' : ''}`}>
                  <Bell className={isMinimalMode ? "h-6 w-6" : "h-5 w-5"} />
                  {!isMinimalMode && <span>Notifications</span>}
                  {/* Notification indicator */}
                  <span className={`${isMinimalMode ? 'absolute -top-2 -right-2' : 'ml-auto'} flex h-5 w-5 items-center justify-center rounded-full bg-amber-500 text-[10px] font-medium text-white`}>
                    3
                  </span>
                </div>
              </SidebarMenuButton>
            ...
            <SidebarMenuItem>
              <SidebarMenuButton 
                ...
                className={`${isMinimalMode ? 'h-14 w-14 mx-auto flex items-center justify-center rounded-xl hover:bg-amber-50 transition-colors' : 'py-3 text-sm'}`}
              >
                <Link to="/messages" className={`flex items-center gap-3 font-medium ${isMinimalMode ? 'justify-center' : ''}`}>
            ...
            <SidebarMenuItem>
              ...
              >
                <div className={`flex items-center gap-3 font-medium cursor-pointer ${isMinimalMode ? 'justify-center' : ''}`}>
            ...
            <SidebarMenuItem>
              <SidebarMenuButton 
                ...
                className={`${isMinimalMode ? 'h-14 w-14 mx-auto flex items-center justify-center rounded-xl hover:bg-amber-50 transition-colors' : 'py-3 text-sm'}`}
              >
                <Link to={`/profile/${userId}`} className={`flex items-center gap-3 font-medium ${isMinimalMode ? 'justify-center' : ''}`}>
            ...
            <SidebarMenuItem>
              <SidebarMenuButton 
                ...
                className={`${isMinimalMode ? 'h-14 w-14 mx-auto flex items-center justify-center rounded-xl hover:bg-amber-50 transition-colors' : 'py-3 text-sm'}`}
              >
                <Link to="/saved" className={`flex items-center gap-3 font-medium ${isMinimalMode ? 'justify-center' : ''}`}>

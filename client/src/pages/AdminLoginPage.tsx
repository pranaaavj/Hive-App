...
import { AdminLoginFormData } from "@/types/auth";
...
export const AdminLoginPage: React.FC = () => {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (touched[name]) {
      const error = validateField(name as keyof AdminLoginFormData, value);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    (Object.keys(formData) as (keyof AdminLoginFormData)[]).forEach((key) => {
  ...
  return (
    <div className="bg-black flex-col flex max-h-screen w-full items-center justify-center">
      <div className="w-[350px] bg-black rounded-[2px] border-gray-400 border space-y-8 mt-8 p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          <InputField
            ...
            error={touched.identifier ? errors.email : undefined}
          />
